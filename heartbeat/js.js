var colorMainLine = "#fe0002";
var colorGroupLine = "#6b6b6c";
var colorWeather = "#0132cc"; 
var colorWeatherOut = "#000"; 
var colorHolidayOn = "#ffff01";
var colorHolidayOff = "#000"; 
var colorHolidayOnOut = "#000";
var colorHolidayOffOut = "#000"; 

var opacSetting = 0.05;
...
var schoolMaxLength = 0;
var lni = 0;

for (var i=0; i < schools.length; i++) {
    if (schools[i].length > schoolMaxLength) {
        schoolMaxLength = schools[i].length;
        lni = i;
    }
}

console.log('Longest school name: ');
console.log(schools[lni]);
